...
(function (global) {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  const TMDB = {
    getTrending: (timeWindow = 'day') => tmdbFetch(`/trending/all/${timeWindow}`),
    getTrendingMovies: (timeWindow = 'day') => tmdbFetch(`/trending/movie/${timeWindow}`),
    getTrendingTV: (timeWindow = 'day') => tmdbFetch(`/trending/tv/${timeWindow}`),
