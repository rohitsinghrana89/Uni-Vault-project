 ...
 * Tests whether the TMDB_API_KEY in .env is valid.
 */
 ...
 * Query params: type (all|movie|tv|person), time (day|week), page
 */
...
/**
 * GET /api/tmdb/search
 * Query params: query (required), page
 */
 ...
 * Forwards any arbitrary TMDB endpoint with query params
 */
